...
window.focus();
if ( ! confirm(msgtext("WARNING:_Your_session_will_tim", timeout) ) )
...
lpn_html += '<td class="product_name_container"><p class="' + sdm_product_name_style + '" style="margin-bottom: 0px; margin-top: 5px;"><nobr>HELPDESK <span id="titleText"></span></nobr></p><p class="' + sdm_product_name_style + '" style="font-size: 13px; margin-top: -2px;">Centrum Wsparcia Użytkownika PKN ORLEN</p></td></tr></table>';
